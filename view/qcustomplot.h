...
public:
  ...
  */
  ...
  QRgb color(double position, const QCPRange &range, bool logarithmic=false) const;
...
protected:
  ...
  // non-property members:
  mutable QVector<QRgb> mColorBuffer;
  mutable bool mColorBufferInvalidated;
};
...
public:
  ...
  //inline double&        color()         {return keyErrorPlus;}
  //inline const double&  color() const   {return keyErrorPlus;}
...
class QCPColorGradient; class QCPData;
...
public:
  ...
  */
  ...
  QCPColorGradient intraPlotColors() const { return mIntraPlotColors; }
  ...
  void setIntraPlotColors(const QCPColorGradient &intraPlotColors);
  void activateIntraPlotColoring(bool activate = true);

  // non-property methods:
  bool isNone() const { return mShape == ssNone; }
  bool isPenDefined() const { return mPenDefined; }
  void applyTo(QCPPainter *painter, const QPen &defaultPen) const;
  void drawShape(QCPPainter *painter, QPointF pos, const QCPData *data = nullptr) const;
  void drawShape(QCPPainter *painter, double x, double y, const QCPData* data = nullptr) const;
  void acquireDataRanges(const QCPDataMap* dataMap) const;
...
protected:
  ...
  QCPColorGradient mIntraPlotColors;
  bool mUseIntraPlotColors = false;
  mutable QCPRange mColorRange;
...
public:
  ...
  */
  ...
  QCPScatterStyle& scatterStyleRef() {return mScatterStyle;}
